...
class RyujinxSettingsFrame(customtkinter.CTkFrame):
    ...
    def update_entry_widgets(self):
        for setting_name, entry_widget in self.matching_dict.items():
            ...
            entry_widget.insert(0, getattr(self.settings.ryujinx, setting_name))
    ...
    def apply(self):
        ...
        for setting_name, entry_widget in self.matching_dict.items():
            try:
                ...
                setattr(self.settings.ryujinx, setting_name, entry_widget.get())
    ...
    def restore_defaults(self):
        self.settings.ryujinx.restore_default()
        self.update_entry_widgets()
